#!/usr/bin/env python3
"""Génère assets/cv-sopra-fullstack.pdf — CV Sopra Steria Full Stack (Java/Angular/Node/React)."""
from pathlib import Path

OUT = Path(__file__).resolve().parent.parent / "assets" / "cv-sopra-fullstack.pdf"
...
def main():
    ...
    p.y -= 14
    p.text(m, 10, "Eleve Ingenieur - Developpeur Full Stack Java / Angular / JS", bold=True, color=ACCENT)
    p.y -= 11
    p.text(
        m, 8.2,
        "Stage fin d'etudes 6 mois (fev. 2027) - ESIGELEC Rouen - Teletravail jusqu'a 2 j/sem.",
        color=MUTED,
    )
    p.y -= 10
    ...
    p.multilines(
        7.8,
        "Eleve ingenieur bac+5 (ESIGELEC), developpeur Full Stack : backend Java / JavaEE et interfaces "
        "Angular, ainsi que des solutions JavaScript (Node.js, React / Vue). Je m'approprie le cycle "
        "complet d'une application - conception, developpement, tests, deploiement - au sein d'une "
        "equipe projet. Rigoureux, force d'initiative, bon relationnel, motive par les projets a impact. "
    ...
    skills = [
        ("Backend Java", "Java, JavaEE / J2EE, Spring Boot, API REST, POO, Node.js"),
        ("Frontend", "Angular, TypeScript, React, Vue.js (notions), JavaScript, HTML/CSS"),
        ("Full Stack JS", "Node.js, Express, React / Next.js, APIs, SQL (MySQL, PostgreSQL)"),
        ("Methodes & Outils", "Git, Docker, CI/CD, Agile/Scrum, conception -> deploiement, Linux"),
    ]
    ...
    projects = [
        (
            "Club Sport - Backend Java / JavaEE (conception -> deploiement)",
            "2025",
            [
                "Analyse des objectifs, conception et developpement d'une application multi-roles",
                "Java / JEE : recherche, cartographie, statistiques, exports, gestion des droits",
                "Docker / Tomcat, qualification des parcours, methodes Agile",
            ],
            "Java | JavaEE | Spring (formation) | MySQL | Docker | Git | Agile",
        ),
        (
            "Factis - Full Stack JS (Node-like stack + UI dynamique)",
            "2025",
            [
                "Solution complete : API, interfaces React/TypeScript, modelisation SQL",
                "Cycle de bout en bout : conception, developpement, mise en production",
                "Contribution concrete aux objectifs produit (clients, factures, analytics)",
            ],
            "React | TypeScript | Node.js | Prisma | PostgreSQL | Docker | Git",
        ),
        (
            "Beniphone - Angular/React skills + API Node.js",
            "2025",
            [
                "Interfaces dynamiques multi-roles et backend JavaScript / Node.js",
                "Travail en equipe, priorisation, livraison iterative",
            ],
            "React | Angular (formation) | Node.js | MySQL | Git",
        ),
        (
            "Smart CMS IA - Technologies modernes & impact",
            "2025",
            [
                "Developpement Full Stack, APIs, jobs asynchrones, documentation",
                "Esprit d'initiative : exploration technique et propositions d'amelioration",
            ],
            "Next.js | React | TypeScript | Node.js | Git | CI",
        ),
        (
            "Mon Demenagement - Cycle application en production",
            "2025",
            [
                "Maintenance / evolution : conception, deploiement, support utilisateurs",
            ],
    ...
    p.y -= 10
    p.bullet("Rigueur, methode et esprit d'initiative sur support / maintenance")
    p.bullet("Bon relationnel et collaboration avec l'equipe et les utilisateurs")
    ...
    p.multilines(
        7.5,
        "Stage fin d'etudes 6 mois a partir de fevrier 2027  |  Teletravail jusqu'a 2 j/semaine  |  Ouvert CDI",
        leading=9.4,
        color=MUTED,
    )
    p.space(2)
    ...
    p.multilines(
        7.5,
        "Java / JavaEE / Angular  |  Node.js / React / Vue  |  Cycle conception -> deploiement  |  Agile",
        leading=9.4,
        color=MUTED,
    )
