#!/usr/bin/env python3
"""Génère assets/cv-thales-lyon.pdf — CV Thales Lyon (Java/Spring Boot/Angular, ESB)."""
from pathlib import Path

OUT = Path(__file__).resolve().parent.parent / "assets" / "cv-thales-lyon.pdf"
...
def main():
    ...
    p.multilines(
        7.8,
        "Eleve ingenieur bac+5 (ESIGELEC), developpeur full stack avec une base solide en Java / Spring Boot "
        "et Angular. Je concois, developpe et documente des fonctionnalites maintenables, en equipe Agile "
        "(daily, sprint review, retro, chiffrage). Interesse par les SI critiques, les flux de donnees "
        "et les micro-applications de supervision. Rigoureux, autonome, a l'aise en anglais technique. "
        "Recherche un stage de fin d'etudes de 6 mois a Lyon a partir de fevrier 2027.",
        leading=9.8,
        color=MUTED,
    )
    ...
    skills = [
        ("Backend", "Java, Spring Boot, JEE, API REST, JWT, documentation de code, C#, Node.js, PHP"),
        ("Frontend", "Angular, TypeScript, React, Next.js, JavaScript, HTML/CSS, Tailwind"),
        ("Data & Flux", "SQL (MySQL, PostgreSQL), modelisation, APIs, notions d'echange / integration de donnees"),
        ("Methodes & Outils", "Agile/Scrum, Git, Docker, CI/CD, Linux, anglais professionnel (ecrit / lu / parle)"),
    ]
    ...
    projects = [
        (
            "Club Sport - Java + dashboards (supervision / metier)",
            "2025",
            [
                "Developpement Java d'une application multi-roles : recherche, cartographie, statistiques",
                "Ecrans de supervision metier, exports et gestion des droits - code documente et maintenable",
                "Docker / Tomcat, travail structure proche d'un SI (evolution + maintenance)",
            ],
            "Java | Spring (formation) | MySQL | Docker | Tomcat | Agile",
        ),
        (
            "Factis - Spring-like stack : API + UI + flux metier",
            "2025",
            [
                "Conception et developpement d'APIs et d'interfaces de gestion (clients, factures, analytics)",
                "Enrichissement / distribution de donnees metier, documentation des modules",
                "Mise en production, iterations et reprise de code claire",
            ],
            "TypeScript | Next.js | Prisma | PostgreSQL | Docker | Git",
        ),
        (
            "Beniphone - Micro-apps de gestion multi-roles",
            "2025",
            [
                "Applications web de gestion (admin, moderation, transactions) avec Angular/React skills",
                "Flux metier traces (KYC, negociations, validations) et ecrans de suivi",
                "Priorisation des taches, livraison iterative et documentation",
            ],
            "React | Angular (formation) | Node.js | Prisma | MySQL",
        ),
        (
            "Smart CMS IA - Features documentees & maintenables",
            "2025",
            [
                "Developpement de fonctionnalites full stack avec code clair et historique de projets",
                "Jobs asynchrones, APIs, UI TypeScript - focus qualite et reprise par un tiers",
            ],
            "Next.js | TypeScript | OpenAI | Supabase | Git",
        ),
        (
            "Mon Demenagement - Evolution / support en production",
            "2025",
            [
                "Maintenance et evolution d'une plateforme en ligne multi-roles",
                "Analyse, developpement, qualification des parcours utilisateurs",
            ],
    ...
    p.multilines(
        7.4,
        "Java, Spring Boot, Angular, TypeScript, React, Docker, API REST, Agile/Scrum, anglais technique",
        leading=9.6,
        color=MUTED,
    )
    p.space(3)
    ...
    p.y -= 10
    p.bullet("Autonomie, rigueur et travail en equipe sur le support et la maintenance")
    p.bullet("Communication claire avec les utilisateurs et documentation des interventions")
    ...
    p.multilines(
        7.5,
        "Francais : langue maternelle  |  Anglais : B2 / professionnel (docs techniques, specs, meetings techniques)",
        leading=9.8,
        color=MUTED,
    )
    p.space(3)
    ...
    p.multilines(
        7.5,
        "Java / Spring Boot / Angular  |  SI critiques et flux de donnees  |  Code propre & maintenable  |  GitHub",
        leading=9.8,
        color=MUTED,
    )
