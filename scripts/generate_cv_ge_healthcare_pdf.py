#!/usr/bin/env python3
"""Génère assets/cv-ge-healthcare.pdf — CV GE HealthCare Buc (C/C++/Python, Linux, UI web)."""
from pathlib import Path

OUT = Path(__file__).resolve().parent.parent / "assets" / "cv-ge-healthcare.pdf"
...
def main():
    ...
    p.y -= 14
    p.text(m, 10, "Eleve Ingenieur - Developpeur Logiciel / Full Stack", bold=True, color=ACCENT)
    p.y -= 11
    p.text(
        m, 8.2,
        "Stage recherche 6 mois (fev. 2027) - Mobilite Buc (78) - ESIGELEC Rouen",
        color=MUTED,
    )
    p.y -= 10
    ...
    p.multilines(
        7.8,
        "Eleve ingenieur bac+5 (ESIGELEC), developpeur logiciel passionne par les nouvelles technologies "
        "et les applications a fort impact. Solide en algorithmique, Python, C/C++ (formation) et Linux ; "
        "expertise web (HTML5, CSS3, JavaScript/TypeScript) pour les interfaces utilisateur. "
        "Curieux des sujets data / IA et des prototypes R&D. Anglais courant (docs, litterature, equipe). "
        "Recherche un stage de recherche de 6 mois a Buc a partir de fevrier 2027.",
        leading=9.8,
        color=MUTED,
    )
    ...
    skills = [
        ("Langages", "Python, C / C++ (formation), Java, JavaScript, TypeScript, SQL, algorithmique"),
        ("UI & Web", "HTML5, CSS3, JavaScript, React, TypeScript - interfaces web, ergonomie, UX"),
        ("Data & IA", "Scripts Python, APIs IA / ML (POC), analyse de donnees, statistiques (bases)"),
        ("Environnement", "Linux, Git, Docker, CI/CD, prototypage, documentation technique, anglais courant"),
    ]
    ...
    projects = [
        (
            "Smart CMS IA - POC data / IA generative",
            "2025",
            [
                "Prototypage full stack integrant des APIs d'IA (pipelines, jobs asynchrones)",
                "Scripts Python / TypeScript, evaluation de solutions, documentation technique",
                "Approche proche R&D : etat de l'art leger, experimentations, iterations",
            ],
            "Python | TypeScript | Next.js | OpenAI | Supabase | Git | Linux",
        ),
        (
            "Factis - Interfaces web & visualisation de donnees",
            "2025",
            [
                "Conception d'interfaces HTML5/CSS3/JS (clients, factures, analytics)",
                "Affichage et exploitation de donnees metier - ergonomie et reactivite",
                "Deploiement Docker, qualite et maintenance du code",
            ],
            "HTML5 | CSS3 | JavaScript | TypeScript | React | PostgreSQL | Docker",
        ),
        (
            "Club Sport - Algorithmique & application logicielle",
            "2025",
            [
                "Developpement d'une application multi-roles (recherche, cartographie, statistiques)",
                "Structures de donnees, traitements, exports - Linux / Docker / Tomcat",
            ],
            "Java | C++ (formation) | MySQL | Docker | Linux | Git",
        ),
        (
            "Beniphone - UI web & parcours utilisateurs",
            "2025",
            [
                "Interfaces web multi-roles, workflows metier, attention a l'ergonomie",
                "Collaboration produit / technique, prototypage iteratif",
            ],
            "JavaScript | React | Node.js | MySQL | Git",
        ),
        (
            "Mon Demenagement - Logiciel en production",
            "2025",
            [
                "Evolution et maintenance d'une plateforme web - fiabilite et support utilisateurs",
            ],
    ...
    p.multilines(
        7.4,
        "Algorithmique, C/C++, Python, Linux, HTML5/CSS3/JavaScript, Java, Docker, IA, anglais technique",
        leading=9.6,
        color=MUTED,
    )
    p.space(3)
    ...
    p.y -= 10
    p.bullet("Rigueur, autonomie et communication claire sur support / maintenance")
    p.bullet("Interet pour les systemes fiables et les usages a impact (sante / industrie)")
    ...
    p.multilines(
        7.5,
        "Francais : langue maternelle  |  Anglais : courant (B2+/docs techniques, litterature, echanges R&D)",
        leading=9.8,
        color=MUTED,
    )
    p.space(3)
    ...
    p.multilines(
        7.5,
        "Stage recherche 6 mois a partir de fevrier 2027  |  Mobilite Buc (Yvelines, 78)",
        leading=9.8,
        color=MUTED,
    )
    p.space(3)
    ...
    p.multilines(
        7.5,
        "IHM & UI web  |  Data Science / IA  |  Prototypage logiciel  |  Linux & Python  |  Tech sante",
        leading=9.8,
        color=MUTED,
    )
