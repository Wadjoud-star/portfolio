#!/usr/bin/env python3
"""Génère assets/cv-de.pdf — CV adapté offre DE (Takima)."""
from pathlib import Path

OUT = Path(__file__).resolve().parent.parent / "assets" / "cv-de.pdf"
...
def main():
    ...
    p.y -= 14
    p.text(m, 10, "Eleve Ingenieur - Full Stack Java / Angular / IA", bold=True, color=ACCENT)
    p.y -= 11
    ...
    # ── Profil (mots-cles DE / ATS) ──
    p.section("Profil")
    p.multilines(
        7.8,
        "Eleve ingenieur bac+5 (ESIGELEC), developpeur full stack motive par les produits internes "
        "et l'IA appliquee : Java / Spring, Angular, API REST, Docker. Je construis des interfaces de saisie, "
        "des dashboards de suivi et des parcours augmentes par LLM (generation / assistance a la redaction). "
        "A l'aise en equipe Agile/Scrum, cote UI comme cote backend. Recherche un stage de fin d'etudes "
        "6 mois a partir de fevrier 2027 - mobilite Paris.",
        leading=9.6,
        color=MUTED,
    )
    ...
    skills = [
        ("Backend", "Java, Spring Boot, Kotlin (bases), Node.js, PHP, C#, Python, API REST, JWT, Swagger"),
        ("Frontend", "Angular, TypeScript, React, Next.js, JavaScript, HTML/CSS, Tailwind, Bootstrap"),
        ("IA & Donnees", "OpenAI, LangChain / Spring AI (notions), PostgreSQL, MySQL, Prisma, Oracle SQL"),
        ("DevOps & Methodes", "Docker, Kubernetes (notions), Git, CI/CD, Linux, Agile/Scrum, UX produit"),
    ]
    ...
    # ── Projets (ordre DE : Java + LLM + dashboards) ──
    ...
    projects = [
        (
            ...
            "2025",
            [
                "App JEE : recherche avancee, cartographie, statistiques et exports de donnees",
                "Dashboards elus et gestion de profils (roles, droits, espaces dedies)",
                "Conteneurisation Docker et deploiement Tomcat - pratique Java / backend",
            ],
        ...
        (
            ...
            "2025",
            [
                "Assistance a la redaction via LLM : blog, LinkedIn, X et illustration a partir d'un theme",
                "Edition enrichie, jobs asynchrones, historique de projets et export Markdown/HTML",
                "Parallele fort avec un moteur d'aide a la redaction de CV augmente par IA",
            ],
            "Next.js | TypeScript | OpenAI | Supabase | TipTap | Stripe",
        ),
        (
            "Factis - Mini-SaaS (interfaces, analytics, production)",
            "2025",
            [
                "Interfaces de saisie clients / factures / depenses et dashboards de suivi",
                "API, roles utilisateur, PDF et abonnement Stripe - produit bout en bout",
                "Mise en production (PostgreSQL) et iteration produit",
            ],
            "Next.js | TypeScript | Prisma | PostgreSQL | Stripe | Docker",
        ),
        (
            "Beniphone - Marketplace multi-roles & admin",
            "2025",
            [
                "Tableaux de bord acheteur / vendeur / admin et workflows metier",
                "Recherche catalogue, KYC, moderation et suivi des transactions",
                "Full stack React / Node avec gestion fine des droits",
            ],
            "React | Node.js | Express | Prisma | MySQL | Tailwind",
        ),
        (
            "Mon Demenagement - Plateforme en production",
            "2025",
            [
                "Plateforme multi-roles en ligne : annonces, offres, messagerie, admin",
                "Cycle analyse (MCD) -> MVC -> deploiement",
            ],
    ...
    p.multilines(
        7.5,
        "Francais : langue maternelle  |  Anglais : B2 (docs techniques, specs Spring/Angular, docs OpenAI)",
        leading=9.8,
        color=MUTED,
    )
    p.space(3)
    ...
    p.multilines(
        7.5,
        "Stage 6 mois a partir de fevrier 2027  |  Mobilite Paris  |  Priorite projet DE (Spring / Angular / IA)",
        leading=9.8,
        color=MUTED,
    )
    p.space(3)
    ...
    p.multilines(
        7.5,
        "LLM pour l'assistance a la redaction et la recherche  |  Dashboards & UX produit  |  Java/Spring & Angular  |  GitHub",
        leading=9.8,
        color=MUTED,
    )
