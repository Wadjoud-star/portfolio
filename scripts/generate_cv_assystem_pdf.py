#!/usr/bin/env python3
"""Génère assets/cv-assystem.pdf — CV Assystem Seine Innopolis (Java/Angular/.NET, DevOps)."""
from pathlib import Path

OUT = Path(__file__).resolve().parent.parent / "assets" / "cv-assystem.pdf"
...
def main():
    ...
    p.y -= 14
    p.text(m, 10, "Eleve Ingenieur - Developpeur Full Stack Java / Angular", bold=True, color=ACCENT)
    p.y -= 11
    p.text(
        m, 8.2,
        "Stage fin d'etudes 6 mois (fev. 2027) - Seine Innopolis / Petit-Quevilly - ESIGELEC Rouen",
        color=MUTED,
    )
    p.y -= 10
    ...
    p.multilines(
        7.8,
        "Eleve ingenieur bac+5 (ESIGELEC Rouen), developpeur Full Stack avec une base solide en Java / JEE "
        "et Angular, et des notions .NET / C#. Je concois, developpe et documente des applications web "
        "robustes et evolutives, en collaboration avec des equipes pluridisciplinaires. A l'aise avec "
        "Git, Docker et les pratiques DevOps (CI/CD), force de proposition sur la qualite, la securite "
        "et la productivite. Motive par l'innovation digitale et l'IA. Base a Rouen - mobilite "
        "Seine Innopolis (Petit-Quevilly) pour un stage de 6 mois a partir de fevrier 2027.",
        leading=9.8,
        color=MUTED,
    )
    ...
    skills = [
        ("Backend", "Java, JEE, Spring Boot, C# / .NET (notions), API REST, Node.js, PHP"),
        ("Frontend", "Angular, TypeScript, React, Vue.js (notions), JavaScript, HTML/CSS"),
        ("Data & Qualite", "SQL (MySQL, PostgreSQL), documentation technique, revues de code, tests"),
        ("DevOps & Cloud", "Git / GitLab, Docker, CI/CD, SonarQube (notions), Linux, deploiement"),
    ]
    ...
    projects = [
        (
            "Club Sport - Java / JEE + Angular skills",
            "2025",
            [
                "Conception et developpement d'une application multi-roles (recherche, stats, exports)",
                "Backend Java, base SQL, Docker / Tomcat - code documente et maintenable",
                "Travail en equipe, revues et qualification des parcours",
            ],
            "Java | JEE | Spring (formation) | MySQL | Docker | Git | Agile",
        ),
        (
            "Smart CMS IA - Innovation & IA generative",
            "2025",
            [
                "POC full stack integrant des APIs d'IA generative (contenu, jobs asynchrones)",
                "Documentation technique, evaluation de solutions, force de proposition",
                "Focus qualite, performance et evolutivite",
            ],
            "Next.js | TypeScript | OpenAI | Supabase | Git | CI",
        ),
        (
            "Factis - Apps robustes & evolutives (Full Stack)",
            "2025",
            [
                "Developpement frontend / backend et APIs (clients, factures, analytics)",
                "Collaboration produit, documentation, deploiement Docker",
            ],
            "TypeScript | React | Prisma | PostgreSQL | Docker | Git",
        ),
        (
            "Beniphone - Collaboration interfonctionnelle",
            "2025",
            [
                "Fonctionnalites web multi-roles avec Angular/React skills et API backend",
                "Definition des besoins, qualite / reactivite, livraison iterative",
            ],
            "React | Angular (formation) | Node.js | MySQL | Git",
        ),
        (
            "Mon Demenagement - Maintenance & documentation",
            "2025",
            [
                "Evolution d'une plateforme en production, support et documentation des parcours",
            ],
    ...
    p.multilines(
        7.4,
        "Java, JEE, Angular, TypeScript, C#/.NET (notions), Docker, Git/GitLab, SQL, Agile, IA",
        leading=9.6,
        color=MUTED,
    )
    p.space(3)
    ...
    p.y -= 10
    p.bullet("Autonomie, bon relationnel et esprit de synthese sur support / maintenance")
    p.bullet("Communication claire et collaboration avec l'equipe")
    ...
    p.multilines(
        7.5,
        "Stage fin d'etudes 6 mois a partir de fevrier 2027  |  Base Rouen - Seine Innopolis (Petit-Quevilly)",
        leading=9.8,
        color=MUTED,
    )
    p.space(3)
    ...
    p.multilines(
        7.5,
        "Java / Angular / .NET  |  DevOps (Docker, GitLab, CI/CD)  |  IA generative  |  Qualite & securite",
        leading=9.8,
        color=MUTED,
    )
